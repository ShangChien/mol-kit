...
###通过寻找可转动键固定二面角，从而固定振动模式
if __name__=="__main__":
    p=Path.cwd()
    for file in p.glob('mol/*.mol'):#file.mol convert by GaussianView
        ...
        for file1 in p.glob(inter_path+'/RE/*.com'):#for Gaussian calculation inputFile.com generated by momap
